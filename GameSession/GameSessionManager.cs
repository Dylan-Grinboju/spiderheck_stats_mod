...
{
    private static readonly Lazy<GameSessionManager> _lazy = new(() => new GameSessionManager());
    ...
    private List<TitleEntry> lastGameTitles = new();
    private readonly List<string> mapsPlayed = new();
    private readonly List<string> perksChosen = new();
    ...
    public void RecordPainLevel()
    {
        ...
        try
        {
            if (PainLevelsScreen.instance is not null)
            {
