...
public static class ModConfig
{
    ...
    private static float ValidateTitlesRevealDelay(float value) => value switch
    {
        < 0f => 0f,
        > 10f => 10f,
        _ => value
    ...
    private static float ValidateScale(float value) => value switch
    {
        < 0.5f => 0.5f,
        > 3.0f => 3.0f,
        _ => value
    ...
    private static float ValidateOpacity(float value) => value switch
    {
        < 0f => 0f,
        > 100f => 100f,
        _ => value
    ...
    private static string ValidateCycleInput(string value)
    {
        ...
        return lower switch
        {
            "none" or "dpad" or "joystick" or "both" => lower,
            _ => "dpad"
        };
    }
}
